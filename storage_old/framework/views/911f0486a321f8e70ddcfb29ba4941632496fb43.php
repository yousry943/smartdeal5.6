...
<br>
        ...
        <!-- <a class="d-block go-link" href="<?php echo e(Request::root()); ?>/submit_myreview/<?php echo e($myreviews->get_paper_reply->filename); ?>" target="_blank" download="<?php echo e($myreviews->get_paper_reply->filename); ?>"> <i class="fas fa-download"></i> Download</a> -->

<!--         <?php echo e(Request::root()); ?>/submit_myreview/<?php echo e($myreviews->get_paper_reply->filename); ?>
 ...
 -->
                 ...
                 <form method="post" action="<?php echo e(url('home/auther-submit-replay')); ?>/<?php echo e($myreviews->paper_id); ?>"  enctype="multipart/form-data">
                                     <?php echo e(csrf_field()); ?>

                                     <div class="w-100 text-center mt-4 mb-1">
                <input  required  type="file" name="filename" class="form-control-file" id="exampleFormControlFile1">

                         <button type="submit" class="btn btn-outline-info m-2"> <i class="fas fa-edit"></i>
                                    Update my review
                                          </button>
                                    </div>
                                </form>
