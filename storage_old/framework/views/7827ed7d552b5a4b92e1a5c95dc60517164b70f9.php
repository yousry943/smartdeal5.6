...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo e(url('admin/login')); ?>"style="color:#FFF"><b>Admin</b></a>ForgetPassword
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg"><?php echo e(session('sent')); ?> <?php echo e(session('error email')); ?>  </p>
