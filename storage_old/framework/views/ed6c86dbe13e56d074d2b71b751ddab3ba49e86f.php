...
<?php if(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale()=='ar'): ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/rtl/css/bootstrap-rtl.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/rtl/css/AdminLTE-rtl.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/rtl/css/skins/_all-skins-rtl.min.css')); ?>">
<?php else: ?>
    <!-- Theme style -->
