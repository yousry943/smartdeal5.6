     ...
     <?php echo $__env->make('user.includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="w-100 container reviews-a" bgpage="reviews-a" submit-a="">
            <section class="py-3 row sc-global">
                <form class="col-12 tr-forms re-edit" method="post" action="<?php echo e(url('home/editor/Review/editer_auther_comments')); ?>" >
                    ...
                    <div class="row  w-100 sb-content m-0">
                        ...
                        <div class="col-12">
                        	<?php if(!empty($editer_auther_comments->first()->id)): ?>

                            	  <?php $__currentLoopData = $editer_auther_comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $editer_auther_comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="alert alert-secondary alert-com" role="alert">
                            	

<?php echo e($editer_auther_comment->comments); ?>

                                <span class="date-alert">By the <?php echo e($editer_auther_comment->get_user->name); ?>  <?php echo e($editer_auther_comment->created_at); ?></span>
