    ...
    <body>
       <?php echo $__env->make('user.includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div class="w-100 container reviews-a" bgpage="reviews-a" submit-a="">
            <form class="py-3 row sc-global" action="<?php echo e(url('home/editor/Review/sendemail/toauther')); ?>" method="post">
                ...
                <div class="col-12 tr-forms">
                    <div class="row w-100 sb-content m-0 pb-0">
                      ...
                      <div class="data-col col-12 col-md-8 col-lg-9">
                      	<input disabled type="email" name="to" class="form-control" id="inputEmail3" value="<?php echo e($user->first()->email); ?>" /></div>
                                </div>

                                <div class="w-100 row data-row data-send">
                                    <div class="data-col col-12 col-md-4 col-lg-3">CC :</div>
                                    <div class="data-col col-12 col-md-8 col-lg-9">
                             <input type="email" name="cc" class="form-control" id="inputEmail3" /></div>
                                </div>

                                <div class="w-100 row data-row data-send">
                                    <div class="data-col col-12 col-md-4 col-lg-3">BCC :</div>
                                    <div class="data-col col-12 col-md-8 col-lg-9">
                               <input type="email" name="bcc" class="form-control" id="inputEmail3"  /></div>
                                </div>
                         <!--        <div class="w-100 row data-row data-send">
                                ...
                                <div class="w-100 row data-row data-send">
                                    ...
                                    <div class="data-col col-12 col-md-8 col-lg-9">
                                 <input type="text" name="subject" class="form-control" id="inputEmail3" value="<?php echo e(@$email_Form->first()->subject); ?>" /></div>
                                </div>
                                ...
                                <div class="w-100 row data-row data-send">
                                    ...
                                    <div class="data-col col-12 col-md-8 col-lg-9">
                                        <textarea class="form-control" name="body" rows="6"><?php echo e(@$email_Form->first()->body); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row m-0 justify-content-center col-12 text-center pb-2">
                                    ...
                                    <button type="submit" class="btn btn-outline-info m-2"> <i class="fas fa-times-circle"></i> Cancel</button>
