<?php $__env->startSection('title'); ?>
  اضافه  ولى لامر<?php $__env->stopSection(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/users/ConferenceTracks')); ?>">
                    ...
                    <label for="username" class="col-sm-4 control-label" > track name </label>
                        ...
                        <div class="col-sm-4 <?php echo e($errors->has('fname') ? ' has-error' : ''); ?>">
                            <input type="text" name="track_name" class="form-control" id="track_name" placeholder="track name" value="<?php echo e(old('track_name')); ?>">
