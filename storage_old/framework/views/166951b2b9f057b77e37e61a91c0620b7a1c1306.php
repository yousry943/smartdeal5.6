				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<div class="ulockd-project-sm-thumb">
							<img class="img-responsive img-whp" style="height:400px;max-width:1000px;width:"  src="<?php echo e(url('/uplodes/newsphoto/'.$learns->first()->get_learn()->first()->image)); ?>" alt="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<article class="ulockd-pd-content">
							...
							<h3><?php echo e($learns->first()->get_learn()->first()->title); ?></h3>
							<p class="project-dp-one"><?php echo e($learns->first()->get_learn()->first()->description); ?></p>
