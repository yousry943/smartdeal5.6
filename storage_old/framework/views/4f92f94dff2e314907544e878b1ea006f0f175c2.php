...
<!-- Mirrored from unlockdesizn.com/html/corporate/financepress/demo/page-team4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Nov 2020 08:17:31 GMT -->
<head>
<meta charset="utf-8">
...
<!-- Title -->
<title>smart-deal24 - <?php echo e($title); ?></title>
<!-- Favicon -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-3">
					<div class="team_post">
						<div class="thumb-box">
			                <img src="<?php echo e(url('/uplodes/newsphoto/'.$team->image)); ?>" alt="1.jpg">
			                <div class="thumb-box-content">
			                    <h3 class="title text-thm2"><?php echo e($team->name); ?></h3>
			                    <span class="post">- <?php echo e($team->jobname); ?></span>
			                    <ul class="icon">
						...
						<div class="team-details bgc-white">
							<h3 class="member-name"><?php echo e($team->name); ?></h3>
							<h5 class="member-post">- <?php echo e($team->jobname); ?></h5>
