		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-3">
					<div class="team_post">
						<div class="thumb-box">
			                <img src="{{url('/uplodes/newsphoto/'.$team->image)}}" alt="1.jpg">
			                <div class="thumb-box-content">
			                    <h3 class="title text-thm2">{{$team->name}}</h3>
			                    <span class="post">- {{$team->jobname }}</span>
			                    <ul class="icon">
						...
						<div class="team-details bgc-white">
							...
							<h5 class="member-post">- {{$team->jobname }}</h5>
