			...
			<!-- TradingView Widget END -->
							...
							<div class="media">
							    <div class="media-left pull-left">
							    	<a href="{{$Latest_Post->id}}">
							      	    <img class="media-object thumbnail"  src="{{url('/uplodes/newsphoto70/'.$Latest_Post->image)}}" alt="1.jpg">
							    	</a>
							    </div>
							    <div class="media-body">
							    	<h4 class="media-heading">{{ Str::limit($Latest_Post->title, 35) }}</h4>
							     {{ Str::limit($Latest_Post->description, 15) }} <a href="{{$Latest_Post->id}}">more...</a>
							    	<strong><a href="{{$Latest_Post->id}}"> {{ Str::limit($Latest_Post->created_at, 20) }} </a></strong>
							    </div>
							</div>
						</div>
					@endforeach
					...
					<h4>FinancePress Testimonial</h4>
								...
								<div class="media-left pull-left">
									...
									<div class="media-body">
										<h4 class="media-heading">Ethan Scott</h4>
				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<div class="ulockd-project-sm-thumb">
							<img class="img-responsive img-whp"  style="height:550px;max-width:1200px;width:" src="{{url('/uplodes/newsphoto/'.$get_data->first()->image)}}" alt="">
						</div>
					</div>
				</div>
