							...
							<div class="three-grid-slider">
								...
								<div class="item">
									<div class="about-box2 text-center">
										<div class="ab-thumb">
											<img class="img-responsive img-whp" src="{{url('/uplodes/newsphoto/'.@$get_story->image)}}" alt="s1.jpg">
								...
								<div class="row">
									...
									<div class="col-md-6 col-md-offset-3 text-center">
										<div class="ulockd-main-title">
											...
											<h2 class="color-white"> {{__('website.AnalystOpinions')}} </h2>
											<p class="color-white">{{__('website.latterOurTraders')}} </p>
									...
									<!-- <div class="row">
										<div class="col-md-6 col-md-offset-3 text-center">
											<div class="ulockd-main-title">
												<h2 class="color-white"> {{__('website.OurTraders')}} </h2>
												<p class="color-white">{{__('website.latterOurTraders')}} </p>
											</div>
										</div>
									</div>
...
@if($get_ourTraders_have_techical_analyse->id ==$get_ourTraders_have_techical_analyses_active)
...
@else
 <div class="item ">
	...
	@endif
								                ...
								                <div class="container-fluid">
								                    <div class="row">
								                        <div class="col-md-4"><img class="img-responsive" src="{{url('/uplodes/newsphoto/'.@$get_ourTraders_have_techical_analyse->image)}}" alt="sh2.png"></div>
								                        <div class="col-md-7">
																					<a href="{{url(LaravelLocalization::setLocale().'/our/Traders/Details/data/'.$get_ourTraders_have_techical_analyse->id)}}" >
								                            <h2>{{$get_ourTraders_have_techical_analyse->title}}</h2>
								                            <p>{{$get_ourTraders_have_techical_analyse->description}}</p>
																						</a>
								                        </div>
								                    </div>
								                </div>
						...
						@endforeach
								        ...
								        <div class="controls">
								            <ul class="nav">
															...
															@foreach ($get_ourTraders_have_techical_analyses as $get_ourTraders_have_techical_analyse)
																															 <li data-target="#custom_carousel" data-slide-to="0"><a href="#"><img style="height:20px;width:20px;"  src="{{url('/uplodes/newsphoto/'.@$get_ourTraders_have_techical_analyse->image)}}"><small>{{$get_ourTraders_have_techical_analyse->title}}</small></a></li>
	...
	<!-- <section class="ulockd-testimonial ulockd-bgthm" style="background-color: #f9fafb;" >
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					<div class="ulockd-main-title">
						<h2 class="color-white"> {{__('website.Pioneersinitiative')}} </h2>
						<p class="color-white">{{__('website.latterOurTraders')}} </p>
					</div>
				</div>
			</div>
	...
	<section class="ulockd-blog bgc-snowshade2 triangle">
		<div class="container">
			...
			<div class="row">
				...
				@foreach ($get_storys_all as $get_story)
									...
									<article class="row blog_post_one">
										<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-6">
											<div class="post_thumb">
												<img class="img-responsive img-whp thumbnail" src="{{url('/uplodes/newsphoto/'.@$get_story->image)}}" alt="1.jpg">
											</div>
										</div>
										<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-6 ulockd-pdng0">
											<div class="post_details">
												...
												<p>{{$get_story->name}}</p>
												<a class="tdu" href="{{url(LaravelLocalization::setLocale().'/Articles/'.$get_story->id)}} ">Read More</a>
											</div>
										</div>
									</article>
								</div>
	...
	<section class="freequently-ask">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<div class="about-box">
						<h2 class="ulockd-mrgn120">{{$get_report->first()->name}}</h2>


						<p>{{$get_report->first()->description}}</p>
						<button type="submit" class="btn btn-default ulockd-btn-thm2">Read More</button>
					</div>
				</div>
				<div class="col-md-6">
					<div class="about-box"><img class="img-responsive img-whp" src="{{url('/uplodes/newsphoto/'.@$get_report->first()->image)}}" alt="3.png"></div>
				</div>
			</div>
		</div>
	</section>
