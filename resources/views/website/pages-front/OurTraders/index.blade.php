				...
				<div class="col-xxs-12 col-xs-6 col-sm-8 col-md-8">
					<div class="about-box style1">
						<div class="author pull-left fn-xsd">
							<h3 class="ulockd-mrgn120">{{$get_OurTraders_have_techical_analyses->name}}</h3>
							<h5>- Our </h5>
						</div>
		                <ul class="social_icons list-inline pull-right fn-xsd">
	                        <li><a class="bgc-fb" href="#"><i class="fa fa-facebook"></i></a></li>
	                        <li><a class="bgc-twtr" href="#"><i class="fa fa-twitter"></i></a></li>
	                        <li><a class="bgc-pint" href="#"><i class="fa fa-pinterest"></i></a></li>
	                        <li><a class="bgc-lnkdn" href="#"><i class="fa fa-linkedin"></i></a></li>
	                        <li><a class="bgc-inst" href="#"><i class="fa fa-instagram"></i></a></li>
		                </ul>
		                ...
		                <div class="progress-levels row">
		                    <div class="col-sm-6 progress-box wow" data-wow-delay="100ms" data-wow-duration="300ms">
			                    <h5 class="box-title">FINANCIAL ANALYSIS</h5>
			                    <div class="inner">
			                        <div class="bar">
			                            <div class="bar-innner"><div class="bar-fill ulockd-bgthm" data-percent="98"><div class="percent"></div></div></div>
			                        </div>
			                    </div>
		                    </div>
		                    <div class="col-sm-6 progress-box wow" data-wow-delay="200ms" data-wow-duration="600ms">
			                    <h5 class="box-title">PROFITABLE INVESTMENT</h5>
			                    <div class="inner">
			                        <div class="bar">
		                    ...
		                    <div class="col-sm-6 progress-box wow" data-wow-delay="200ms" data-wow-duration="900ms">
			                    <h5 class="box-title">BUSINESS SUPPORT</h5>
			                    <div class="inner">
			                        <div class="bar">
			                            <div class="bar-innner"><div class="bar-fill ulockd-bgthm" data-percent="85"><div class="percent"></div></div></div>
			                        </div>
			                    </div>
		                    </div>
		                    <div class="col-sm-6 progress-box wow" data-wow-delay="200ms" data-wow-duration="1200ms">
			                    <h5 class="box-title">TAXES AND ACCOUNTING</h5>
			                    <div class="inner">
			                        <div class="bar">
			                            <div class="bar-innner"><div class="bar-fill ulockd-bgthm" data-percent="97"><div class="percent"></div></div></div>
			                        </div>
			                    </div>
		                    </div>
		                </div>
				...
				<div class="col-md-8 col-lg-9">
					<div class="row">
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-5 ulockd-pad395">
							<div class="img-box">
								<div class="cb-thumb">
									<img class="img-responsive img-whp" src="images/service/1.jpg" alt="1.jpg">
								</div>
							</div>
						</div>
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-7 ulockd-pad395">
							<div class="img-box">
								<div class="cb-details style2">
									...
									<p>Metalworking is the process of working with metals to create individual parts, assemblies, or large-scale structures. The term covers a wide range of work from large ships and bridges to precise engine parts and delicate jewelry. It therefore includes a correspondingly wide range of skills, processes, and tools. Its historical roots span cultures, civilizations, and millennia. </p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row ulockd-mrgn1220">
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-5 ulockd-pad395">
							<div class="img-box">
								<div class="cb-thumb">
									<img class="img-responsive img-whp" src="images/service/3.jpg" alt="3.jpg">
								</div>
							</div>
						</div>
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-7 ulockd-pad395">
					...
					<div class="row ulockd-mrgn1220">
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-5 ulockd-pad395">
							<div class="img-box">
								<div class="cb-thumb">
									<img class="img-responsive img-whp" src="images/service/4.jpg" alt="4.jpg">
								</div>
							</div>
						</div>
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-7 ulockd-pad395">
					...
					<div class="row ulockd-mrgn1220">
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-5 ulockd-pad395">
							<div class="img-box">
								<div class="cb-thumb">
									<img class="img-responsive img-whp" src="images/service/5.jpg" alt="5.jpg">
								</div>
							</div>
						</div>
						<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-7 ulockd-pad395">
