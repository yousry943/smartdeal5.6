...
<!-- Mirrored from unlockdesizn.com/html/corporate/financepress/demo/page-contact3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Nov 2020 08:11:56 GMT -->
<head>
<meta charset="utf-8">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="ulockd-contact-form">
                        <form id="contact_form" name="contact_form" class="contact-form" action="{{url('submit/contact')}}" method="post" novalidate="novalidate">
   {{csrf_field()}}
