...
@endforeach
			...
			<div class="col-md-8 col-lg-9">
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<div class="ulockd-project-sm-thumb">
							<img class="img-responsive img-whp" style="height:400px;max-width:1000px;width:" src="{{url('/uplodes/newsphoto/'.$learn_Details->first()->image)}}" alt="87/7/*7">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						 @foreach($learn_Details as $learn_Detail)
