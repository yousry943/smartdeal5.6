...
@include('website.includes.header')
 ...
 @foreach($learns as $learn)
                ...
                <div class="last-post">
                  ...
                  <div class="swa-panel">
										@foreach($learn->get_learn AS $row)
                      <li class="recent-post">

                       <a href="{{url(LaravelLocalization::setLocale().'/Courses_Details/'.$row->id)}}" class="list-group-item">{{$row->title}}</a>
                      </li>
									@endforeach
                  </div>
				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<div class="ulockd-project-sm-thumb">
							<img class="img-responsive img-whp" style="height:400px;max-width:1000px;width:"  src="{{url('/uplodes/newsphoto/'.$learns->first()->get_learn()->first()->image)}}" alt="">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 ulockd-mrgn1210">
						<article class="ulockd-pd-content">
							...
							<h3>{{$learns->first()->get_learn()->first()->title}}</h3>
							<p class="project-dp-one">{{$learns->first()->get_learn()->first()->description}}</p>
