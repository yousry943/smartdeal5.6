                          ...
                          <div class="modal-body">
                            <div class="row">
                              <div class="col-sm-12 col-md-8 col-md-offset-2 text-center">
                                ...
                                <img src="{{ asset('assets/website/images/loading.gif')}}" alt="Loading" style="display:none"
                                               id="login_gif">
          ...
          <ul class="list-inline">
            <li>
              <div class="dropdown profile-button text-center">
                <button class="dropbtn color-white"><i class="fa fa-globe"></i> welcome: {{ Auth::user()->name }}</button>
                <div class="dropdown-content">
                  <a href="{{url('user/logout')}}"> <span></span> Logout</a>
