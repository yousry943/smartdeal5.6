        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data"  action="{{url(LaravelLocalization::setLocale().'/admin/slider')}}">
                        {{csrf_field()}}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="title" class="form-control" id="name" placeholder="name" value="{{ old('title') }}">
                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" name="description" class="form-control" id="name" placeholder="description" value="{{ old('description') }}">
                                                    </div>
