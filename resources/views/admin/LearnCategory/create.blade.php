        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data"  action="{{url(LaravelLocalization::setLocale().'/admin/learncategory')}}">
                        {{csrf_field()}}
                    <div class="box-body">
                  ...
                  <div class="form-group">
                <label for="category" class="col-sm-4 control-label">Menu Categorys</label>
                <div class="col-sm-4">
                <select name="menuCategory_id" id="menuCategory_id" class="select2 form-control " >
