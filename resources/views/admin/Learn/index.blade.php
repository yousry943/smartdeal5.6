...
@section('content')
    ...
    <section class="content">
        ...
        <div class="col-md-12">
                ...
                <a href="{{url('/admin/learn/create')}}" class="btn btn-primary pull-right margin-bottom">
                                ...
                                <tr>
                                  <td><a href="{{url($new->image)}} ">  <img style="height:90px;max-width:200px;width:"  src="{{url('/uplodes/newsphoto/'.$new->image)}}" alt="Italian Trulli"> {{$new->image}}</a> </td>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{url('/admin/learn/'.$new->id.'/edit')}}" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></a>
...
<button class="btn btn-danger" class="btn btn-danger btn-circle"   data-href="{{url('admin/learn/'.$new->id.'/delete')}}" data-toggle="modal" data-target="#confirm-delete">
