    ...
    <section class="content">
        ...
        <div class="row">
          <div class="col-md-12">
                  ...
                  <a href="{{url('/admin/story/create')}}" class="btn btn-primary pull-right margin-bottom">
                            ...
                            @foreach($news as $new)
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{url('/admin/story/'.$new->id.'/edit')}}" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></a>
...
<button class="btn btn-danger" class="btn btn-danger btn-circle"   data-href="{{url('admin/story/'.$new->id.'/delete')}}" data-toggle="modal" data-target="#confirm-delete">
