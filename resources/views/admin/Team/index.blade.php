                            ...
                            @foreach($news as $new)
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{url('/admin/team/'.$new->id.'/edit')}}" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></a>
...
<button class="btn btn-danger" class="btn btn-danger btn-circle"   data-href="{{url('admin/team/'.$new->id.'/delete')}}" data-toggle="modal" data-target="#confirm-delete">
