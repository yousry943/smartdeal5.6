...
class NewsController extends Controller
{
    ...
    public function index()
    {
         ...
         // dd($user);
        $news = OurTraders_news::where('user_id','=',$user_id)->with('get_categories','get_language')->get();

        return view('website.user-dashboard.news.index',compact('news'));
    }
    ...
    public function create()
    {
        ...
        // return redirect()->back();
             ...
             return view('website.user-dashboard.news.create',compact('categorys','languages'));
...
// //        Admin::find($id)->roles()->sync($request->role);
       ...
       $news = new OurTraders_news();

      $news->user_id = Auth::guard('web')->user()->id;
      ...
      $news->save();
        return redirect('/user/news')->withFlashMessage('News has been Stored');
    ...
    public function edit($id)
    {
        ...
        $news = OurTraders_news::where('id','=',$id)
        ->where('user_id','=',$user_id)
        ->with('get_categories','get_language')->get();

        // dd($news);
        return view('website.user-dashboard.news.edit',compact('news','categorys','languages'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/user/news')->withFlashMessage('News Edited !!');
    ...
    public function destroy($id)
    {
        ...
        $news = OurTraders_news::find($id);
          ...
          $news->delete();
       return redirect('/user/news')->withFlashMessage('News Deleted');
